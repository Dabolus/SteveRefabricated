package com.steve.ai.refabricated.action;

import com.steve.ai.refabricated.SteveMod;
import com.steve.ai.refabricated.action.actions.*;
import com.steve.ai.refabricated.ai.ResponseParser;
import com.steve.ai.refabricated.ai.TaskPlanner;
...
public class ActionExecutor {
    ...
    public void processNaturalLanguageCommand(String command) {
        ...
        try {
            ...
            if (SteveConfig.get().enableChatResponses) {
    ...
    private void sendToGUI(String steveName, String message) {
        if (steve.level().isClientSide) {
            com.steve.ai.refabricated.util.ClientProxy.addSteveMessage(steveName, message);
        }
    }
    ...
    if (ticksSinceLastAction >= SteveConfig.get().actionTickDelay) {
