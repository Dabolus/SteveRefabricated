...
public class CombatAction extends BaseAction {
    ...
    protected void onStart() {
        ...
        if (target == null) {
            com.steve.ai.refabricated.SteveMod.LOGGER.warn("Steve '{}' no targets nearby", steve.getSteveName());
        }
    }
    ...
    protected void onTick() {
        ...
        if (ticksRunning > MAX_TICKS) {
            ...
            com.steve.ai.refabricated.SteveMod.LOGGER.info("Steve '{}' combat complete, invulnerability disabled", 
                steve.getSteveName());
        ...
        if (Math.abs(currentX - lastX) < 0.1 && Math.abs(currentZ - lastZ) < 0.1) {
            ...
            if (ticksStuck > 40 && distance > ATTACK_RANGE) {
                ...
                ticksStuck = 0;
                com.steve.ai.refabricated.SteveMod.LOGGER.info("Steve '{}' was stuck, teleported closer to target", 
                    steve.getSteveName());
            }
        } else {
            ticksStuck = 0;
    ...
    protected void onCancel() {
        ...
        steve.setFlying(false);
        target = null;
        com.steve.ai.refabricated.SteveMod.LOGGER.info("Steve '{}' combat cancelled, invulnerability disabled", 
            steve.getSteveName());
    }
    ...
    private void findTarget() {
        ...
        target = nearest;
        if (target != null) {
            com.steve.ai.refabricated.SteveMod.LOGGER.info("Steve '{}' locked onto: {} at {}m", 
