...
public class OpenAIClient {
    ...
    public OpenAIClient() {
    this.apiKey = SteveConfig.get().apiKey;
    ...
    body.addProperty("model", SteveConfig.get().model);
    body.addProperty("temperature", SteveConfig.get().temperature);
    body.addProperty("max_tokens", SteveConfig.get().maxTokens);
