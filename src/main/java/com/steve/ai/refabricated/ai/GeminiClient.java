...
public class GeminiClient {
    ...
    public GeminiClient() {
        this.apiKey = SteveConfig.get().apiKey; // We'll use the same config for now
    ...
    generationConfig.addProperty("temperature", SteveConfig.get().temperature);
    generationConfig.addProperty("maxOutputTokens", SteveConfig.get().maxTokens);
